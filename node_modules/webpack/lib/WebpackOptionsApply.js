...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/steve/.vscode/extensions/wallabyjs.console-ninja-1.0.367/out/buildHook/index.js').default({tool: 'webpack', checkSum: '209827e570dcdae64cd5fcDBYLAksFDQRSUFYCUAYNVFJRAFBa', mode: 'build'}); } catch(cjsError) { try { import('file:///home/steve/.vscode/extensions/wallabyjs.console-ninja-1.0.367/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '209827e570dcdae64cd5fcDBYLAksFDQRSUFYCUAYNVFJRAFBa', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
